...
void AnimationInfo::SetNewAnimation(const StormImage *celSprite, int numberOfFrames, int ticksPerFrame, AnimationDistributionFlags flags /*= AnimationDistributionFlags::None*/, int numSkippedFrames /*= 0*/, int distributeFramesBeforeFrame /*= 0*/)
{
...
void AnimationInfo::ChangeAnimationData(const StormImage *celSprite, int numberOfFrames, int ticksPerFrame)
{
